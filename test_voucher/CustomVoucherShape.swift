...
class VoucherShape: UIView {
    ...
    private var cut_additional_height: CGFloat = 1.5
    ...
    override func draw(_ rect: CGRect) {
        ...
        //vouhcer cut top
        path.addLine(to: CGPoint(x: width - right_width - voucher_cut_radius, y: 0))
        path.addLine(to: CGPoint(x: width - right_width - voucher_cut_radius, y: cut_additional_height))
        path.addArc(withCenter: CGPoint(x: width - right_width, y: cut_additional_height), radius: -voucher_cut_radius, startAngle: 0, endAngle: .pi, clockwise: false)
        path.addLine(to: CGPoint(x: width - right_width + voucher_cut_radius, y: 0))
        //top right
        ...
        //vouhcer cut bottom
        path.addLine(to: CGPoint(x: width - right_width + voucher_cut_radius, y: height))
        path.addLine(to: CGPoint(x: width - right_width + voucher_cut_radius, y:height  - cut_additional_height))
        path.addArc(withCenter: CGPoint(x: width - right_width, y: height - cut_additional_height), radius: voucher_cut_radius, startAngle: 0, endAngle: .pi, clockwise: false)
         path.addLine(to: CGPoint(x: width - right_width - voucher_cut_radius, y: height))
        //bottom left
        ...
        //dash
        let  p0 = CGPoint(x: width - right_width, y: self.voucher_cut_radius + cut_additional_height)
        let  p1 = CGPoint(x: width - right_width, y: height - self.voucher_cut_radius - cut_additional_height)
    ...
    public func drawVouncher(rightWidth: CGFloat, cornerRadius: CGFloat, voucherCutRadius: CGFloat, backgroundColor: UIColor, borderColor: UIColor, dashColor: UIColor, cutAdditionalHeight: CGFloat) {
        ...
        self.cut_additional_height = cutAdditionalHeight;
